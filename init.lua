...
require('lazy').setup({
  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    ...
    config = function()
      ...
      vim.keymap.set('n', 'gt', gs.stage_hunk, { desc = '[G]it S[t]age hunk' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>d', vim.lsp.buf.hover, 'Open Definition Float')
          ...
          map('vgrd', function() return require('telescope.builtin').lsp_definitions {jump_type = 'vsplit'} end, '[V]ertical Split - [G]oto [D]efinition')
      ...
      local servers = {
        ...
        eslint = {
          settings = {
            nodePath = '~/.nvm/versions/node/v20.10.0/lib/node_modules/',
          },
        },
      }
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      vim.cmd.highlight 'StatusLine ctermfg=15 guifg=#292d35 ctermbg=239 guibg=#f8de92 cterm=bold gui=bold'
